...
\subsubsection{Cold-weather Regimen} % śiśira?
...
and amphibious creatures.\footnote{We repeat ``meats''
for ease in English.} % pādināñ 
...
\item[30] 
If one desires nourishment at the approach of winter, %puṣṭim icchan himāgame 
one may partake of % niṣeveta
clear alcoholic drinks % madyāni ca prasannāni
and whatever gives strength, %  yac ca kiñcid balapradam
according to one’s inclination. % kāmatas

\item[31--32ab] % 31cd and 32ab are absent in the vulgate
Bathing % avagāhanam
in moderately warm or tepid % taile koṣṇe sukhoṣṇe vā
oil is recommended. % praśastam
So also, % tathā
one should engage in oil massage including the head, perform vigorous exercise, bathe in tepid water, and wash with only warm water. 
