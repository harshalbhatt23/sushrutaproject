...
interrogation.\footnote{\cite[43]{vulgate}: \dev{dūtanimittaśakunamaṅgalānulomyenāturagṛhamabhigamya,
...
\end{quote}
The extra passage that appears to reject the \emph{Carakasaṃhitā}'s view, and to promote a six-fold diagnosis, is absent.

Luckily, the commentary by the learned scholar Cakrapāṇidatta
(fl.\,1075, Bengal) on this part of the \emph{Suśrutasaṃhitā}
survives. This commentary was edited and published in 1939 by
Yādavaśarman T. Ācārya, who printed the “some people say” passage in
parentheses and noted that this extra passage was not accepted by
Cakrapāṇidatta.\footnote{\cite[77, n.\,2]{acar-1939}: \dev{अयं पाठश्च
    चक्रासंमतः}. }  In fact, a close reading of Cakrapāṇi's commentary at
    this point shows not that he disagreed with the passage, but that he
    was entirely unaware of it.  He discussed diagnoses through the other
    senses, but he derived the idea from the word “and (\dev{ca})" in the
    phrase “he should look, palpate \textit{and} interrogate\ldots.”  The
    parenthetical “some say” passage was not a part of the \SS\
    manuscripts available to him in the eleventh century.  Thus, we can
    say that it was added to the text of the \emph{Suśrutasaṃhitā} some
    time after the oldest Nepalese manuscript (878 \CE) and
    probably after the eleventh century.
...
can no longer be sustained.\footnote{However, another \dev{ityeke}
    ...
    \CS, Cakrapāṇidatta actually cited this passage of the \SS\ explicitly and 
...
to the \SS\ after the ninth century. 
